 <script src="{{URL::to('/')}}/assets/libs/jquery/jquery.min.js"></script>
        ...
        <script src="{{URL::to('/')}}assets/libs/tinymce/tinymce.min.js"></script>
        <script src="{{URL::to('/')}}/assets/libs/summernote/summernote-bs4.min.js"></script>
        <script src="{{URL::to('/')}}/assets/js/pages/form-editor.init.js"></script>
