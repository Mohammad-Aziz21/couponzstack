                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="allcat_links_div">
                            <ul>
                                <li><a href="{{URL::to('/')}}/stores">All</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"A"}}">A</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"B"}}">B</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"C"}}">C</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"D"}}">D</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"E"}}">E</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"F"}}">F</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"G"}}">G</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"H"}}">H</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"I"}}">I</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"J"}}">J</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"K"}}">K</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"L"}}">L</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"M"}}">M</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"N"}}">N</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"O"}}">O</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"P"}}">P</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"Q"}}">Q</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"R"}}">R</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"S"}}">S</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"T"}}">T</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"U"}}">U</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"V"}}">V</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"W"}}">W</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"X"}}">X</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"Y"}}">Y</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"Z"}}">Z</a></li>
                                <li><a href="{{URL::to('/')}}/all-stores/{{"0-9"}}">0-9</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="clearfix"></div>
                ...
                @foreach ($value as $values)
                    <div class="sitemap_cat_list_div">
                        <ul>
                        <li><a href="{{URL::to('/')}}/stores/{{$values->slug}}">{{$values->store_name}} ({{$values->totaloffers}})</a></li>
                        </ul>
                    </div>
                @endforeach
                </div>
