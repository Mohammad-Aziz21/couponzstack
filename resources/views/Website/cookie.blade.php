            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <p>
                        ...
                        <br/>
                        COUPONZSTACK.COM uses Cookies to differentiate between the numerous users on the website along with their favorites and browsing period information to deliver a higher quality of service and a  more personalized experience whenever the user chooses to visit us again.<br/>
                        <br/>
                        Third-parties that provide services to COUPONZSTACK.COM may also use Cookies which will be mentioned within their privacy policies. 
                    </p>
                    ...
                    <h4>COUPONZSTACK.COM and Third-party employed by us collects Usage Data.</h4>
