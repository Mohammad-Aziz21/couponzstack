            ...
            <div class="col-sm-12">
                <div class="page_breadcrumb">
                    <ul>
                        ...
                        <li>
                            <a href="/couponzstack/special-events">
                                Events
                            </a>
                        </li>
                    </ul>
...
{{--            <div class="clearfix"></div>--}}
            <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="sitemap_cat_list_div">
                    <ul>
                        @for($i=0;$i<7;$i++)
                          <li><a href="event/{{$event_name[$i]->event_slug}}">{{$event_name[$i]->event_name}}</a></li>
                        @endfor
...
{{--                    <ul>--}}
{{--                        @for($i=0;$i<13;$i++)--}}
{{--                            <li><a href="{{$event_name[$i]->event_name}}/{{$event_name[$i]->event_slug}}">{{$event_name[$i]->event_name}}</a></li>--}}
{{--                        @endfor--}}
{{--                    </ul>--}}
{{--                </div>--}}
{{--            </div>--}}
